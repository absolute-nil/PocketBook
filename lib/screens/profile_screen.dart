...
class MapScreenState extends State<ProfileScreen>
  ...
  String name = "", rollNo = "", year = "", imageUrl;
                                      ...
                                      decoration: new BoxDecoration(
                                        ...
                                        image: new DecorationImage(
                                          image: NetworkImage(profileData
                                                  ...
                                                  null
                                              ? profileData.image
                                              : "https://img.favpng.com/24/15/4/computer-icons-avatar-user-profile-blog-png-favpng-9wEFLzf04C5m4ShX8e57uczCy.jpg"),
                                          fit: BoxFit.cover,
                                        ),
                                      )),
                                ],
                            ...
                            Padding(
                                ...
                                child: new Row(
                                  ...
                                  children: <Widget>[
                                    new Flexible(
                                      child: new TextFormField(
                                        initialValue: profileData.rollno,
                                        enabled: !_status,
                                        onSaved: (value) {
                                          rollNo = value;
                                          print(value);
                            ...
                            Padding(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    Flexible(
                                      child: TextFormField(
                                        initialValue: profileData.image,
                                        enabled: !_status,
                                        onSaved: (value) {
                                          imageUrl = value;
                                          print(imageUrl);
                ...
                onPressed: () {
                  setState(() {
                    ...
                    Provider.of<Profile>(context, listen: false)
                        .addProfile(name, rollNo, year, imageUrl);
